<div class="navbar-color container padding-bottom padding-top">
	<div class="navbar-header header-width header">
		...
		<div class="fotos">
			<a class="navbar-brand" href="/administradors/dashboardAdministradors.php"><img class="imatge1" alt="LogoAplicatiuWeb"
					src="{{url('/images/LogoBlau1_2.png')}}"></a>
			<a class="navbar-brand margin-left-icon" href="/administradors/dashboardAdministradors.php"><img class="imatge2"
			...
			<div class="nav navbar-nav right">
				<li class="dropdown"><a href="#"
					...
					<ul class="dropdown-menu">
						<li><a id="padding-top-dropdown" href="/administradors/perfil.php">El meu perfil</a></li>
						<li><a href="/administradors/missatgeria.php">Missatgeria</a></li>
